...
<html lang="en">
  ...
  <!-- End Navbar -->
    ...
    <form action="" method="POST">
     <h3 align="center">Form Peserta PORSENI 2020 Cabang Olahraga</h3><br> 
  ...
  <div>
    ...
    &nbsp;<select name="cabang" class="form-control">
      ...
      <option value="Bola Voli Pantai">Bola Voli Pantai</option>
      <option value="Karate">Karate</option>
      <option value="Pencak Silat">Pencak Silat</option>
      <option value="Taekwondo">Taekwondo</option>
      <option value="Panjat Dinding">Panjat Dinding</option>
  ...
  <a href="tampildatapendaftar.php" class="btn btn-primary" role="button" aria-pressed="true">Tampil</a>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  mysqli_query($koneksi,"INSERT INTO cabor(nama,nim,jenis_kelamin,jurusan,prodi,tingkat,alamat,agama,email,nohp,cabang,berat,tinggi) values('$nama','$nim','$jk','$jurusan','$prodi','$tingkat','$alamat','$agama','$email','$nohp','$cabang','$berat','$tinggi')"); 
}
  ?>