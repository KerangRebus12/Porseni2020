...
<html lang="en">
  <head>
    ...
    <title>Data Pendaftar PORSENI 2020 Cabang Olahraga</title>
  </head>
  <body>
    <!-- Navbar -->
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="tampildatapendaftar.php">Pendaftar Cabor</a>
      <a class="nav-item nav-link" href="tampildatapendaftarcasen.php">Pendaftar Casen</a>
    </div>
</nav>
    <!-- End Navbar -->

    <h1 align="center">Data Pendaftar PORSENI 2020 Cabang Olahraga</h1>
  ...
  <tbody>
    ...
    $no = 1;
    $data = mysqli_query($koneksi,"SELECT * FROM cabor");
